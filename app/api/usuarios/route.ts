...
export async function PATCH(req: NextRequest) {
  ...
  try {
    ...
    // Permissao SEPARADA das telas: e um recorte de dado, nao uma tela.
    // So entra no UPDATE se vier como booleano — mesma allowlist
    // explicita dos demais campos, sem mass assignment.
